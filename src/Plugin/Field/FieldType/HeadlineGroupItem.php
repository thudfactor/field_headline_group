...
namespace Drupal\field_headline_group\Plugin\Field\FieldType;
...
/**
 * Plugin implementation of the 'field_headline_group' field type.
 * 
 * @FieldType(
 *   id = "field_headline_group",
  ...
  public function fieldSettingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['title_behavior'] = [
      ...
      '#options' => [
        ...
        static::HG_OVERRIDE => t('Fall back to entity title'),
        static::HG_PROHIBIT => t('Always use entity title')
      ],
    ];
